...
struct NoteColor {
    ...
    var localizedName: String {
        NotyL10n.text("color.\(name.lowercased())")
    }
...
struct NoteFace {
    ...
    var localizedName: String {
        body.isEmpty ? NotyL10n.text("font.system") : name
    }
}
...
enum Ink {
    ...
    static var face: NoteFace {
        let want = NotySettings.noteFontName
...
enum NoteTextDirection: String, Codable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .automatic:   NotyL10n.text("direction.automatic")
        case .leftToRight: NotyL10n.text("direction.left_to_right")
        case .rightToLeft: NotyL10n.text("direction.right_to_left")
        }
    }
...
struct Note: Identifiable, Hashable {
    ...
    var displayTitle: String {
        ...
        return derived.isEmpty ? NotyL10n.text("note.untitled") : derived
    }
...
enum Fmt {
    ...
    static func ago(_ d: Date) -> String {
        if Date().timeIntervalSince(d) < 60 { return NotyL10n.text("date.just_now") }
