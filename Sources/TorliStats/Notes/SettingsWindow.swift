...
enum DeckCorner: String, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .topLeft: return NotesL10n.text("settings.deck.position.top_left")
        case .bottomLeft: return NotesL10n.text("settings.deck.position.bottom_left")
        case .topRight: return NotesL10n.text("settings.deck.position.top_right")
        case .bottomRight: return NotesL10n.text("settings.deck.position.bottom_right")
        }
    }
...
struct NotesSettingsView: View {
    ...
    private var deckTab: some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            row(NotesL10n.text("settings.deck.position")) {
